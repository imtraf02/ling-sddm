    ...
    Item {
        ...
        Component.onCompleted: {
            if (Config.loginAreaPosition === "left") {
                ...
                anchors.verticalCenterOffset = Config.loginAreaMarginTop;
        ...
        RowLayout {
            id: loginLayout
            spacing: 20 * Config.generalScale
            ...
            UserSelector {
                id: userSelector
                Layout.preferredWidth: Config.avatarActiveSize * Config.generalScale
                Layout.preferredHeight: (loginScreen.state === "selectingUser" ? loginScreen.height / 2 : Config.avatarActiveSize * Config.generalScale)
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    Layout.alignment: Config.loginAreaPosition === "left" ? Qt.AlignLeft : (Config.loginAreaPosition === "right" ? Qt.AlignRight : Qt.AlignHCenter)
                }
                ...
                RowLayout {
                    ...
                    IconButton {
                        ...
                        tooltipText: !Config.tooltipsDisableLoginButton && (!Config.loginButtonShowTextIfNoPassword || loginScreen.userNeedsPassword) ? "Login" : ""
